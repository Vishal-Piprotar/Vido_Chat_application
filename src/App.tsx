...
export default function App() {
  ...
  const isDarkTheme = useAppSelector((quick_meet) => quick_meet.auth.isDarkTheme);
  ...
  useEffect(() => {
    ...
    if (theme) {
      ...
      localStorage.setItem("quick_meet-theme", "light");
    }
  }, []);
      ...
      <EuiProvider colorMode={theme}>
        <EuiThemeProvider modify={overrides}>
          <Routes>
            ...
            <Route path="/create1on1" element={<Private />} />
